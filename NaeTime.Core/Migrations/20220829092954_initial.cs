        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RssiStreamId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RssiStreamReading", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RssiStreamReading_RssiStream_RssiStreamId",
                        column: x => x.RssiStreamId,
                        principalTable: "RssiStream",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RssiStreamReading_RssiStreamId",
