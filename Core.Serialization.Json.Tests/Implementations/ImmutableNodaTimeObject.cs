...
{
    class ImmutableNodaTimeObject
    {
        public ImmutableNodaTimeObject(Instant instantVal, OffsetDateTime offsetDateTimeVal, ZonedDateTime zonedDateTimeVal, LocalDateTime localDateTimeVal, LocalDate localDateVal, LocalTime localTimeVal, Offset offsetVal, Interval intervalVal, Duration durationVal)
        {
