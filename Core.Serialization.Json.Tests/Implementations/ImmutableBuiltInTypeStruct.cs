...
{
    public struct ImmutableBuiltInTypeStruct
    {
        ...
        public ImmutableBuiltInTypeStruct(bool boolVal, byte byteVal, char charVal, decimal decimalVal, double doubleVal, float floatVal, int intVal, uint uIntVal, long longVal, ulong uLongVal, short shortVal, ushort uShortVal, string stringVal)
        {
            BoolVal = boolVal;
            ByteVal = byteVal;
            CharVal = charVal;
