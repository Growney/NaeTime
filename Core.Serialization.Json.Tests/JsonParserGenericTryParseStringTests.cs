...
{
    public class JsonParserGenericTryParseStringTests
    {
        private readonly JsonParser _parser = new JsonParser();

        [Fact]
        public void For_GenericTryParseString_When_StringIsNull_Expect_False()
        {
            string data = null;
            Assert.False(_parser.TryParse<ImmutableBuiltInTypeObject>(data, out var _));
        }
        [Fact]
        public void For_GenericTryParseString_When_StringIsEmpty_Expect_False()
        {
            string data = string.Empty;
            Assert.False(_parser.TryParse<ImmutableBuiltInTypeObject>(data, out var _));
        }
        [Fact]
        public void For_GenericTryParseString_When_StringIsBad_Expect_False()
        {
        ...
        [Fact]
        public void For_GenericTryParseString_When_EmptyJsonObject_Expect_True()
        {
            string emptyJson = "{}";
            Assert.True(_parser.TryParse<ImmutableBuiltInTypeObject>(emptyJson, out var _));
        }

        [Fact]
        public void For_GenericTryParseString_When_BuiltInJsonObject_Expect_True()
        {
            Assert.True(_parser.TryParse<ImmutableBuiltInTypeObject>(TestValues.TestJson, out var _));
        }
        [Fact]
        public void For_GenericTryParseString_When_BuiltInJsonStruct_Expect_True()
        {
            Assert.True(_parser.TryParse<ImmutableBuiltInTypeStruct>(TestValues.TestJson, out var _));
        }
        [Fact]
        public void For_GenericTryParseString_When_BuiltInJsonObject_Expect_CorrectValues()
        {
            _parser.TryParse<ImmutableBuiltInTypeObject>(TestValues.TestJson, out var parsed);
        ...
        [Fact]
        public void For_GenericTryParseString_When_BuiltInJsonStruct_Expect_CorrectValues()
        {
            _parser.TryParse<ImmutableBuiltInTypeStruct>(TestValues.TestJson, out var parsed);
            Assert.True(parsed.BoolVal);
            Assert.Equal(TestValues.TestJsonObject.ByteVal, parsed.ByteVal);
            Assert.Equal(TestValues.TestJsonObject.CharVal, parsed.CharVal);
            Assert.Equal(TestValues.TestJsonObject.DecimalVal, parsed.DecimalVal);
        ...
        [Fact]
        public void For_GenericTryParseString_When_NestedObjects_Expect_CorrectValues()
        {
            _parser.TryParse<ImmutableParentObject>(TestValues.NestedJson, out var parsed);
        ...
        [Fact]
        public void For_GenericTryParseString_When_NodaTimeJsonObject_Expect_CorrectValues()
        {
            _parser.TryParse<ImmutableNodaTimeObject>(TestValues.TestNodaTimeJson, out var parsed);
        ...
        [Fact]
        public void For_GenericTryParseString_When_NodaTimeJsonStruct_Expect_CorrectValues()
        {
            _parser.TryParse<ImmutableNodaTimeStruct>(TestValues.TestNodaTimeJson, out var parsed);
