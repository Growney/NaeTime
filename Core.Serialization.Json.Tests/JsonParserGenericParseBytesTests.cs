...
{
    public class JsonParserGenericParseBytesTests
    {
        private readonly JsonParser _parser = new JsonParser();

        [Fact]
        public void For_GenericParseBytes_When_BinaryDataIsNull_Expect_ThrowsArgumentNullException()
        {
            byte[] data = null;
            Assert.Throws<ArgumentNullException>(() => _parser.Parse<ImmutableBuiltInTypeObject>(data));
        }
        [Fact]
        public void For_GenericParseBytes_When_BinaryDataIsEmpty_Expect_ThrowsArgumentException()
        {
            byte[] data = new byte[0];
            Assert.Throws<ArgumentException>(() => _parser.Parse<ImmutableBuiltInTypeObject>(data));
        }
        [Fact]
        public void For_GenericParseBytes_When_BinaryDataIsBad_Expect_ThrowsFormatException()
        {
        ...
        [Fact]
        public void For_GenericParseBytes_When_EncodedEmptyJsonObject_Expect_EmptyStruct()
        {
            string emptyJson = "{}";
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(emptyJson);
            var parsed = _parser.Parse<ImmutableBuiltInTypeStruct>(encoded);
            Assert.Equal(new ImmutableBuiltInTypeStruct(), parsed);
        }

        [Fact]
        public void For_GenericParseBytes_When_EncodedBuiltInJsonObject_Expect_CorrectValues()
        {
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(TestValues.TestJson);
            var parsed = _parser.Parse<ImmutableBuiltInTypeObject>(encoded);
        ...
        [Fact]
        public void For_GenericParseBytes_When_EncodedBuiltInJsonStruct_Expect_CorrectValues()
        {
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(TestValues.TestJson);
            var parsed = _parser.Parse<ImmutableBuiltInTypeStruct>(encoded);
        ...
        [Fact]
        public void For_GenericParseBytes_When_NestedObjects_Expect_CorrectValues()
        {
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(TestValues.NestedJson);

            var parsed = _parser.Parse<ImmutableParentObject>(encoded);
        ...
        [Fact]
        public void For_GenericParseBytes_When_NodaTimeJsonObject_Expect_CorrectValues()
        {
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(TestValues.TestNodaTimeJson);
            var parsed = _parser.Parse<ImmutableNodaTimeObject>(encoded);
        ...
        [Fact]
        public void For_GenericParseBytes_When_NodaTimeJsonStruct_Expect_CorrectValues()
        {
            byte[] encoded = System.Text.Encoding.UTF8.GetBytes(TestValues.TestNodaTimeJson);
            var parsed = _parser.Parse<ImmutableNodaTimeStruct>(encoded);
