...
{
    public class JsonParserParseStringTests
    {
        private readonly JsonParser _parser = new JsonParser();

        [Fact]
        public void For_ParseString_When_StringDataIsNull_Expect_ThrowsArgumentNullException()
        {
            string data = null;
            Assert.Throws<ArgumentNullException>(() => _parser.Parse(typeof(ImmutableBuiltInTypeObject), data));
        }
        [Fact]
        public void For_ParseString_When_StringIsEmpty_Expect_ThrowsArgumentException()
        {
            string data = string.Empty;
            Assert.Throws<ArgumentException>(() => _parser.Parse(typeof(ImmutableBuiltInTypeObject), data));
        }
        [Fact]
        public void For_ParseString_When_StringIsBad_Expect_ThrowsFormatException()
        {
            string data = "totally not json";
            Assert.Throws<FormatException>(() => _parser.Parse(typeof(ImmutableBuiltInTypeObject), data));
        }

        [Fact]
        public void For_ParseString_When_EmptyJsonObject_Expect_EmptyStruct()
        {
            string emptyJson = "{}";
            var parsed = _parser.Parse(typeof(ImmutableBuiltInTypeStruct), emptyJson);
            Assert.Equal(new ImmutableBuiltInTypeStruct(), parsed);
        }

        [Fact]
        public void For_ParseString_When_BuiltInJsonObject_Expect_CorrectValues()
        {
            var parsedObject = _parser.Parse(typeof(ImmutableBuiltInTypeObject), TestValues.TestJson);
        ...
        [Fact]
        public void For_ParseString_When_BuiltInJsonStruct_Expect_CorrectValues()
        {
            ;
            var parsedStruct = _parser.Parse(typeof(ImmutableBuiltInTypeStruct), TestValues.TestJson);
        ...
        [Fact]
        public void For_ParseString_When_NestedObjects_Expect_CorrectValues()
        {
            var parsedObject = _parser.Parse(typeof(ImmutableParentObject), TestValues.NestedJson);
        ...
        {
            var parsedObject = _parser.Parse(typeof(ImmutableNodaTimeObject), TestValues.TestNodaTimeJson);
        ...
        {
            var parsedStruct = _parser.Parse(typeof(ImmutableNodaTimeStruct), TestValues.TestNodaTimeJson);
