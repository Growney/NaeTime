...
public struct Band
{
    ...
    public static readonly Band F = new(2, "F", "F", new List<BandFrequency>
    {
    ...
    public static readonly Band R = new(3, "R", "R", new List<BandFrequency>
    {
    ...
    public static readonly Band DJI_25Mbps = new(4, "DJI 25Mbps", "DJI 25", new List<BandFrequency>
    {
    ...
    public static readonly Band DJI_50Mbps = new(5, "DJI 50Mbps", "DJI 50", new List<BandFrequency>
    {
    ...
    public static readonly Band DJI_03 = new(6, "DJI 03", "DJI 03", new List<BandFrequency>
    {
        new("CH1",(int)DJI0350Mbps.CH1),
        new("CH2",(int)DJI0350Mbps.CH2),
        new("CH3",(int)DJI0350Mbps.CH3),
    });
    public static readonly Band HDZero = new(7, "HDZero", "HDZ", new List<BandFrequency>
    {
        new("R1",(int)Frequency.HDZero.R1),
        new("R2",(int)Frequency.HDZero.R2),
        new("R3",(int)Frequency.HDZero.R3),
        new("R4",(int)Frequency.HDZero.R4),
        new("R5",(int)Frequency.HDZero.R5),
        new("R6",(int)Frequency.HDZero.R6),
        new("R7",(int)Frequency.HDZero.R7),
        new("R8",(int)Frequency.HDZero.R8)
    });
    public static readonly Band Walksnail_Race = new(8, "Walksnail Race", "WS Race", new List<BandFrequency>
    {
    ...
    public static readonly Band Walksnail_25Mbps = new(10, "Walksnail 25Mbps", "WS 25", new List<BandFrequency>
    {
    ...
    public static readonly Band Walksnail_50Mbps = new(11, "Walksnail 50Mbps", "WS 50", new List<BandFrequency>
    {
