...
public struct Band
{
    ...
    public static readonly Band Walksnail25Mbps = new(10, "Walksnail 25Mbps", "WS 25", new List<BandFrequency>
        {
                new("CH1",(int)Frequency.Walksnail25Mbps.CH1),
                new("CH2",(int)Frequency.Walksnail25Mbps.CH2),
                new("CH3",(int)Frequency.Walksnail25Mbps.CH3),
                new("CH4",(int)Frequency.Walksnail25Mbps.CH4),
                new("CH5",(int)Frequency.Walksnail25Mbps.CH5),
                new("CH6",(int)Frequency.Walksnail25Mbps.CH6),
                new("CH7",(int)Frequency.Walksnail25Mbps.CH7),
                new("CH8",(int)Frequency.Walksnail25Mbps.CH8)
            });

    public static readonly Band Walksnail50Mbps = new(12, "Walksnail 50Mbps", "WS 50", new List<BandFrequency>
        {
                new("CH1",(int)Frequency.Walksnail50Mbps.CH1),
                new("CH2",(int)Frequency.Walksnail50Mbps.CH2),
                new("CH3",(int)Frequency.Walksnail50Mbps.CH3),
                new("CH8",(int)Frequency.Walksnail50Mbps.CH8)
            });
