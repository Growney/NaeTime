...
public partial class EditableSerialELRSBackpackDetails
{
    [Inject]
    ...
    [Parameter]
    [EditorRequired]
    public Func<SerialELRSBackpack, Task> OnValidSubmit { get; set; } = null!;

    [Parameter]
    [EditorRequired]
    public SerialELRSBackpack Details { get; set; } = null!;
