...
public record ImmersionRCLapRFLaneStatusConfigurationFailed(Guid TimerId, byte Lane, bool DesiredStatus, string Reason);
...
public record ImmersionRCLapRFLaneFrequencyTuningFailed(Guid TimerId, byte Lane, byte? BandId, int FrequencyInMHz, string Reason);
...
public record ImmersionRCLapRFLaneThresholdConfigurationFailed(Guid TimerId, byte Lane, float Threshold, string Reason);
...
public record ImmersionRCLapRFLaneGainConfigurationFailed(Guid TimerId, byte Lane, ushort Gain, string Reason);
